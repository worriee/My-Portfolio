      ...
      <div ref={contentRef} className="w-full md:w-3/4 p-8 h-screen overflow-y-auto">
        ...
        <div id="home" className="h-screen -m-8 bg-cover bg-center flex flex-col justify-center items-center" style={{ backgroundImage: `url(${myPic2})`}}>
          ...
          <div className="flex flex-row mt-6 space-x-4">
            ...
            <a href="/My_Resume.pdf" download="Mahilum_Resume.pdf" className="flex items-center px-4 py-2 bg-transparent text-black border border-black rounded-md hover:bg-gray-300 hover:text-black transition duration-300 [-webkit-text-stroke:1px_black]">
